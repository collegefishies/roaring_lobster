...
always @(negedge int_clk) begin: HEX_COUNTER_COUNTER
    ...
    if (reset == 1) begin
        ...
        if ((((bin_int + rom_0_dout) > ((10 ** 10) - 1)) && ((add == 1'b1) && (sub == 1'b0)))) begin
            bin_int <= ((bin_int + rom_0_dout) - (10 ** 10));
        end
        else if (((bin_int < rom_0_dout) && ((sub == 1'b1) && (add == 1'b0)))) begin
            bin_int <= (($signed({1'b0, bin_int}) - $signed({1'b0, rom_0_dout})) + (10 ** 10));
        end
        else begin
            if (((add == 1'b1) && (sub == 1'b0))) begin
                bin_int <= (bin_int + rom_0_dout);
            end
...
always @(dig_incr) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_0_0_INNER
    if ((0 == dig_incr)) begin
        to_add[0] = 1;
        to_subtract[0] = 1;
    end
...
always @(dig_incr, hex_l[0], to_add[0], to_subtract[0]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_1_0_INNER
    if ((1 < dig_incr)) begin
        to_add[1] <= 0;
        to_subtract[1] <= 0;
    end
...
always @(dig_incr, hex_l[1], to_add[1], to_subtract[1]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_2_0_INNER
    if ((2 < dig_incr)) begin
        to_add[2] <= 0;
        to_subtract[2] <= 0;
    end
...
always @(dig_incr, hex_l[2], to_add[2], to_subtract[2]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_3_0_INNER
    if ((3 < dig_incr)) begin
        to_add[3] <= 0;
        to_subtract[3] <= 0;
    end
...
always @(dig_incr, hex_l[3], to_add[3], to_subtract[3]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_4_0_INNER
    if ((4 < dig_incr)) begin
        to_add[4] <= 0;
        to_subtract[4] <= 0;
    end
...
always @(dig_incr, hex_l[4], to_add[4], to_subtract[4]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_5_0_INNER
    if ((5 < dig_incr)) begin
        to_add[5] <= 0;
        to_subtract[5] <= 0;
    end
...
always @(dig_incr, hex_l[5], to_add[5], to_subtract[5]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_6_0_INNER
    if ((6 < dig_incr)) begin
        to_add[6] <= 0;
        to_subtract[6] <= 0;
    end
...
always @(dig_incr, hex_l[6], to_add[6], to_subtract[6]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_7_0_INNER
    if ((7 < dig_incr)) begin
        to_add[7] <= 0;
        to_subtract[7] <= 0;
    end
...
always @(dig_incr, hex_l[7], to_add[7], to_subtract[7]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_8_0_INNER
    if ((8 < dig_incr)) begin
        to_add[8] <= 0;
        to_subtract[8] <= 0;
    end
...
always @(dig_incr, hex_l[8], to_add[8], to_subtract[8]) begin: HEX_COUNTER_ADDSUBLOGIC_0_LOGIC_9_0_INNER
    if ((9 < dig_incr)) begin
        to_add[9] <= 0;
        to_subtract[9] <= 0;
    end
...
always @(dig_incr) begin: HEX_COUNTER_ROM_0_READ
    case (dig_incr)
        0: rom_0_dout = 1;
        1: rom_0_dout = 10;
        2: rom_0_dout = 100;
        ...
        4: rom_0_dout = 10000;
        5: rom_0_dout = 100000;
        6: rom_0_dout = 1000000;
        7: rom_0_dout = 10000000;
        8: rom_0_dout = 100000000;
        default: rom_0_dout = 1000000000;
    endcase
end
